...
Partial Class MDIParent1
    ...
    Private Sub InitializeComponent()
        ...
        ' 
        OpenToolStripMenuItem.DropDownItems.AddRange(New ToolStripItem() {REGISTRATIONToolStripMenuItem, COURSEToolStripMenuItem, ACCOUNTSToolStripMenuItem})
        ...
        ACCOUNTSToolStripMenuItem.Size = New Size(224, 26)
